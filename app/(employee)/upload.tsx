...
export default function UploadScreen(): React.ReactElement {
  ...
  return (
    <>
      <Stack.Screen options={{ title: 'Upload Work Photos' }} />
...
// ─── Local textarea (matches Input border style, 100px height) ─────────────────
...
const styles = StyleSheet.create({
  ...
  dateLabel: { fontFamily: FontFamily.medium, fontSize: FontSize.sm, color: Colors.textPrimary },
  dateValue: { fontFamily: FontFamily.regular, fontSize: FontSize.sm, color: Colors.textSecondary },
});
